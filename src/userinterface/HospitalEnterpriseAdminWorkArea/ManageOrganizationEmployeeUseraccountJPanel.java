...
import business.role.Role.HospitalRoleType;
...
public class ManageOrganizationEmployeeUseraccountJPanel extends javax.swing.JPanel {
    ...
    public void populateRoleComboBox(Enterprise enterprise){
        employeeRoleJComboBox.removeAllItems();
        if(enterprise.getEnterpriseType().equals(Enterprise.EnterpriseType.Hospital)){
            for(HospitalRoleType type : Role.HospitalRoleType.values()){
                if(!type.equals(Role.HospitalRoleType.HospitalManager)) employeeRoleJComboBox.addItem(type);
            }
        }
    }
    /**
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        HospitalRoleType type = (HospitalRoleType) employeeRoleJComboBox.getSelectedItem();
        ...
        if(type.equals(HospitalRoleType.Doctor)){
            UserAccount account = organization.getUserAccountCatalog().createUserAccount(username, password, employee, new DoctorRole());
        }
        else if(type.equals(HospitalRoleType.LabAssistant)){
            UserAccount account = organization.getUserAccountCatalog().createUserAccount(username, password, employee, new AssistantRole());
        }
        else if(type.equals(HospitalRoleType.Nurse)){
            UserAccount account = organization.getUserAccountCatalog().createUserAccount(username, password, employee, new NurseRole());
        }
        else if(type.equals(HospitalRoleType.Patient)){
            UserAccount account = organization.getUserAccountCatalog().createUserAccount(username, password, employee, new PatientRole());
        }
        else{
            ;
        }
